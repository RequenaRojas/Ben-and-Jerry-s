...
<!DOCTYPE html>
  ...
  <body>
    ...
    <ul>
        ...
        %>
                <li class="Header3">Bienvenido<br><%= usu.getNom_usuario()%></li>
        <% 
            }
        %>
        <li><a class="active3" href="RegistrarProdu.jsp">Registrar Helado</a></li>
    ...
    <section class="contenedorPrincipal">
        ...
        <div class="div-contenido" style="text-align: center;">
            ...
            <br><br>
            <a class="link3" href="RegistrarAdmin.jsp">¡Únetenos!</a>
            <br><br><br>
        </div>
    </section>
